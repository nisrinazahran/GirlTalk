const api = (() => {
  ...
  async function createCommentThreads({ threadId, content }) {
  ...
  async function commentUpVote(threadId, commentId) {
  ...
  async function commentDownVote(threadId, commentId) {
  ...
  async function commentNeutralVote(threadId, commentId) {
